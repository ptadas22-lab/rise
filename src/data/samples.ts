...
export const SAMPLE_IDEAS: BusinessIdea[] = [
  {
    ...
    monthlyProfit: "₹25,000 - ₹40,000 / month",
    riskLevel: "Low",
    score: 92,
    whyItWorks: "Colleges have a steady daily flow of energetic students, faculty, and visitors looking for affordable, quick, hot refreshments and a casual social hangout spot in their breaks.",
    firstSteps: [
  ...
  },
  {
    ...
    monthlyProfit: "₹12,000 - ₹20,000 / month",
    riskLevel: "Medium",
    score: 85,
    whyItWorks: "Handmade, preservative-free traditional pickles carry heavy nostalgic appeal in urban residential areas where busy working couples crave authentic home-style flavors but lack the time or skill to ferment them.",
    firstSteps: [
